...
INSERT INTO users (id, login, password, role) VALUES
    ('11111111-1111-1111-1111-111111111111', 'admin', '$2a$10$testhashwillbereplaced', 'ADMIN')
    ON CONFLICT (login) DO NOTHING;

-- Insert test regular user (password: user123)
INSERT INTO users (id, login, password, role) VALUES
    ('22222222-2222-2222-2222-222222222222', 'user1', '$2a$10$testhashwillbereplaced', 'USER')
    ON CONFLICT (login) DO NOTHING;
